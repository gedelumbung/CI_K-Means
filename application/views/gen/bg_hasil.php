...
<div id="container">
	...
	<br>
	<table cellpadding="5" border="1" cellspacing="0" width="100%">
		<tr align="center"><td>Kode</td><td>Nama</td><td>Nilai</td><td>Asal</td><td>Matematika</td><td>Inggris</td><td>Komputer</td><td>Rata-Rata</td><td colspan="5">Distance</td><td>Predikat</td></tr>
		<?php foreach($siswa->result_array() as $s){ ?>
		<tr><td><?php echo $s['kode']; ?></td><td><?php echo $s['nama']; ?></td><td><?php echo $s['nilai']; ?></td><td><?php echo $s['asal']; ?></td><td><?php echo $s['mtk']; ?></td><td><?php echo $s['ing']; ?></td><td><?php echo $s['kom']; ?></td><td><?php echo $s['rata_rata']; ?></td><td><?php echo $s['d1']; ?></td><td><?php echo $s['d2']; ?></td><td><?php echo $s['d3']; ?></td><td><?php echo $s['d4']; ?></td><td><?php echo $s['d5']; ?></td><td><?php echo $s['predikat']; ?></td></tr>
		<?php } ?>
	</table>
	</div>
